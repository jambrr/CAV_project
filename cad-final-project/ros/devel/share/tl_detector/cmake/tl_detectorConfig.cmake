...
if("TRUE" STREQUAL "TRUE")
  set(tl_detector_SOURCE_PREFIX /host/ros/src/tl_detector)
  set(tl_detector_DEVEL_PREFIX /host/ros/devel)
  ...
  set(tl_detector_INSTALL_PREFIX /host/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tl_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/host/ros/src/tl_detector/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(tl_detector_EXPORTED_TARGETS ${${tl_detector_dep}_EXPORTED_TARGETS})
endforeach()
