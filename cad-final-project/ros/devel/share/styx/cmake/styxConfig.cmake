...
if("TRUE" STREQUAL "TRUE")
  set(styx_SOURCE_PREFIX /host/ros/src/sim_bridge/styx)
  set(styx_DEVEL_PREFIX /host/ros/devel)
  set(styx_INSTALL_PREFIX "")
  set(styx_PREFIX ${styx_DEVEL_PREFIX})
else()
  set(styx_SOURCE_PREFIX "")
  set(styx_DEVEL_PREFIX "")
  set(styx_INSTALL_PREFIX /host/ros/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'styx' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/host/ros/src/sim_bridge/styx/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(styx_EXPORTED_TARGETS ${${styx_dep}_EXPORTED_TARGETS})
endforeach()
