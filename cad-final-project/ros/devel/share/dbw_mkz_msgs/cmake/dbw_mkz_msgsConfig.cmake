...
if("TRUE" STREQUAL "TRUE")
  set(dbw_mkz_msgs_SOURCE_PREFIX /host/ros/src/sim_bridge/dbw_mkz_msgs)
  set(dbw_mkz_msgs_DEVEL_PREFIX /host/ros/devel)
  ...
  set(dbw_mkz_msgs_INSTALL_PREFIX /host/ros/install)
...
if(NOT "/host/ros/devel/include " STREQUAL " ")
  set(dbw_mkz_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/host/ros/devel/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dbw_mkz_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/host/ros/src/sim_bridge/dbw_mkz_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /host/ros/devel/lib;/opt/ros/noetic/lib)
...
set(dbw_mkz_msgs_EXPORTED_TARGETS "dbw_mkz_msgs_generate_messages_cpp;dbw_mkz_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(dbw_mkz_msgs_EXPORTED_TARGETS ${${dbw_mkz_msgs_dep}_EXPORTED_TARGETS})
endforeach()
